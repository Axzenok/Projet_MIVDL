...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 20 mai 2024 à 19:34
...
--
-- Base de données : `2024_quizmivdl`
--
CREATE DATABASE IF NOT EXISTS `2024_quizmivdl` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `2024_quizmivdl`;
...
CREATE TABLE IF NOT EXISTS `joueur` (
  ...
  `motDePasse` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `question` (
  ...
  `Libelle` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(1, 'réseaux sociaux 01', 'réseaux sociaux quizz n°1', '2023-10-16 18:00:00', 0, 15, 'F', 1),
(2, 'mots de passes 01', 'comment bien gérer ses mots de passes ? ', '2023-10-16 18:00:00', 0, 15, 'M', 2),
(3, 'cyber-harcèlement 01', 'cyber harcèlement mais encore ?', '2023-10-17 18:00:00', 0, 15, 'F', 1),
(4, 'culture cyber_01', 'le bon sens en action, ou pas ? ', '2023-10-18 18:00:00', 0, 15, 'F', 2),
(5, 'réseaux sociaux 02', 'réseaux sociaux quizz n°2', '2023-10-16 18:00:00', 0, 15, 'F', 1),
(6, 'entreprise_01', 'la cyber en entreprise', '2023-10-16 18:00:00', 127, 15, 'F', 5);
...
--
ALTER TABLE `joueur`
  ADD CONSTRAINT `joueur_section_FK` FOREIGN KEY (`Section_id`) REFERENCES `section` (`P_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
